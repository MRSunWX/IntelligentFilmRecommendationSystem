...
class Model:
    ...
    def __init__(self,has_fit=True):
        ...
        self.data, self.movies_orig, self.users_orig = DataSet.load_dataset(r"C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\model\data_preprocess.pkl")
        # 嵌入矩阵的维度
        self.embed_dim = 32
        # 用户ID个数
        ...
        if(self.has_fit==True):
            ...
            self.users_matrics=pickle.load(open(r'C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\model\users_matrics.pkl', mode='rb'))
            self.movies_matrics=pickle.load(open(r'C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\model\movies_matrics.pkl', mode='rb'))
    ...
    def fit(clf):
        ...
        with tf.Session(graph=clf.train_graph) as sess:
            ...
            # Save Model
            saver.save(sess, r"C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\model\model")  # , global_step=epoch_i
    ...
    def loead_sess(self):
        ...
        with loaded_graph.as_default():
            print('加载模型')
            loader = tf.train.import_meta_graph(r'C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\model\model.meta')
            loader.restore(sess, r"C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\model\model")
    ...
    def create_movies_matrics(self):
        ...
        pickle.dump((np.array(movies_matrics).reshape(-1, 200)), open(r"C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\model\movies_matrics.pkl", 'wb'))
    ...
    def create_users_matrics(self):
        ...
        pickle.dump((np.array(users_matrics).reshape(-1, 200)), open(r"C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\model\users_matrics.pkl", 'wb'))
