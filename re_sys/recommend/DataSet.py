...
def preprocessing_users():
    ...
    users = pd.read_table(r'C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\data\users.dat', sep='::', header=None, names=users_title, engine='python')
...
def preprocessing_movies():
    ...
    movies = pd.read_table(r'C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\data\movies.dat', sep='::', header=None, names=movies_title, engine='python')
...
def preprocessing_ratings():
    ...
    ratings = pd.read_table(r'C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\data\ratings.dat', sep='::', header=None, names=ratings_title, engine='python')
...
def load_dataset(model_path):
    ...
    pickle.dump((
                ...
                users_orig), open(r'C:\Users\sccdl\Desktop\Personalized-recommend-master\re_sys\recommend\model\data_preprocess.pkl', 'wb'))
